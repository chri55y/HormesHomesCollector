...
module GoogleDirections
  class Request
    ...
    def initialize
      ...
      session.timeout         = GoogleDirections.config.timeout
      session.connect_timeout = GoogleDirections.config.connect_timeout
    end
    ...
    def private_key
      GoogleDirections.config.private_key
    end

    def client_id
      GoogleDirections.config.client_id
    end

    def sign?
      GoogleDirections.config.sign
    end
  end
end